...
public class MainActivity extends AppCompatActivity {
    ...
    public void mostrarMenu(View view) {
        ...
        List<String> listaLogin = Arrays.asList("Itachi", "Luke", "Madara","Sasuke","Sakura");
        ...
        if(listaLogin.contains(login.getText().toString()) && senha.getText().toString().equals("6601")){
